...
from helper.datasets.d4rl import load_environment
...
class MazeRenderer:
    ...
    def renders(self, observations, conditions=None, title=None, updated_background=None):
        plt.clf()
        fig = plt.gcf()
...
class Maze2dRenderer(MazeRenderer):
    ...
    def renders(self, observations, conditions=None, env_name=None, **kwargs):
